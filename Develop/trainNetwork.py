...
# For simpler reproducability of training results, all .py source files are copied to the Logs folder of the current
# training
...
lr_finder = LRFinder(min_lr=1e-7,
                     max_lr=1e-3,
                     steps_per_epoch=np.ceil(len(trainFrames) / 32.0),
                     epochs=epochs)
'''
